            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="box box-success">
                ...
                <div class="box-body chat" id="chat-box">
                  <!-- chat item -->
                  <div class="item">
                    <img src="/institute/Public/images/user4-128x128.jpg" alt="user image" class="online">
                    <p class="message">
                      <a href="#" class="name">
                  ...
                  <!-- chat item -->
                  <div class="item">
                    <img src="/institute/Public/images/user3-128x128.jpg" alt="user image" class="offline">
                    <p class="message">
                      <a href="#" class="name">
                  ...
                  <!-- chat item -->
                  <div class="item">
                    <img src="/institute/Public/images/user2-160x160.jpg" alt="user image" class="offline">
                    <p class="message">
                      <a href="#" class="name">
